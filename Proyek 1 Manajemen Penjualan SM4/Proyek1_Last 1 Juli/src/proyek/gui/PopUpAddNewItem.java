...
//                lastStock = catalogProduct.getProducts().get(indeks).getProductStock();
//                catalogProduct.getProducts().get(indeks).setSalePrice(newProduct.getSalePrice());
//                catalogProduct.getProducts().get(indeks).setProductStock(lastStock + newProduct.getProductStock());
//                catalogProduct.getProducts().get(indeks).setBuyItemPrice(newProduct.getBuyItemPrice());
                return true;
            }
            row++;
        }
