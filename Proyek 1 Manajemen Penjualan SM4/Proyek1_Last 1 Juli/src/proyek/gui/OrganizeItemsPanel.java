...
//                lastStock = catalogProducts.getProducts().get(indeks).getProductStock();
//                catalogProducts.getProducts().get(indeks).setSalePrice(newProduct.getSalePrice());
//                catalogProducts.getProducts().get(indeks).setProductStock(lastStock + newProduct.getProductStock());
//                catalogProducts.getProducts().get(indeks).setBuyItemPrice(newProduct.getBuyItemPrice());
//                jTableItemLists.setValueAt(newProduct.getSalePrice(), row, 3);
//                jTableItemLists.setValueAt(newProduct.getProductStock(), row, 4);
//                jTableItemLists.setValueAt(newProduct.getBuyItemPrice(), row, 5);
                return true;
            }
            row++;
        }
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPaneOI, javax.swing.GroupLayout.DEFAULT_SIZE, 209, Short.MAX_VALUE)
                .addContainerGap())
        );
...
//            tableProducts.removeRow(indeksInTable);
//            TableRowSorter<DefaultTableModel> tableSearch = new TableRowSorter<>(tableProducts);
//            jTableItemLists.setRowSorter(tableSearch);
            ShowProducts();
        }
